...
module.exports = {
  ...
  // Testing Guild IDs untuk pendaftaran slash command cepat
  testGuildIds: [], // masukkan ID guild/server untuk testing (opsional)
  // Firebase configzz
  firebaseEnabled: true,
  // Menghapus MongoDB URL sepenuhnya
  status: "https://abiyyufahri.rf.gd",
  commandsDir: "./src/commands", //Updated path to new commands directory
